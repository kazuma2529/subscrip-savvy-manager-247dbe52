  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <div className="container mx-auto px-4 py-4 md:py-8">
        {/* Header */}
        <div className="flex flex-col gap-4 mb-6 md:mb-8 md:flex-row md:items-center md:gap-4">
          <Link to="/">
            <Button variant="outline" size="sm" className="w-full md:w-auto text-black bg-white border-white/30 hover:bg-white/90 hover:text-black h-12 md:h-auto">
              <ArrowLeft className="w-4 h-4 mr-2" />
              戻る
            </Button>
          </Link>
          <div className="text-center md:text-left">
            <h1 className="text-2xl md:text-3xl font-bold text-white mb-1 md:mb-2">通知設定</h1>
            <p className="text-sm md:text-base text-slate-300">メール通知の設定を管理できます</p>
          </div>
        </div>
            ...
            <CardContent className="p-4 md:p-6 space-y-6">
              ...
              <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                <div className="flex-1">
                  <Label className="text-white text-base">メール通知</Label>
              ...
              {settings.email_notifications_enabled && (
                <>
                  ...
                  <div className="space-y-3">
                    <Label className="text-white text-base">トライアル終了通知</Label>
                    <div className="flex flex-wrap gap-2">
                      {settings.trial_notification_days.map((days, index) => (
                        <Badge key={index} variant="outline" className="text-slate-300 border-slate-600 h-8 px-3">
                          {days}日前
                        </Badge>
                      ))}
                    </div>
                  ...
                  {/* 支払い通知タイミング */}
                  <div className="space-y-3">
                    <Label className="text-white text-base">支払い通知</Label>
                    <div className="flex flex-wrap gap-2">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      <Badge variant="outline" className="text-slate-300 border-slate-600 h-8 px-3">
                        毎日 21:00 (JST)
                      </Badge>
                    </div>
                    <p className="text-xs md:text-sm text-slate-400">
              ...
              <div className="flex gap-3 pt-4">
                <Button 
                  ...
                  disabled={saving}
                  className="flex-1 bg-purple-600 hover:bg-purple-700 text-white h-12 md:h-auto"
                >
                  {saving ? '保存中...' : '設定を保存'}
                </Button>
              </div>
              ...
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4 mt-6">
                <h3 className="text-blue-300 font-medium mb-3 flex items-center gap-2 text-sm md:text-base">
